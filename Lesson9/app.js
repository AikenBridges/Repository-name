...
function create(){
	...
	enemy = game.add.sprite(760, 200, "baddie");
...
function moveEnemy(){
	...
	//else if P is on mid pl
	}else if(player.y>250&&player.y<400){
		//if E is on bot pl
		if(enemy.y>400){
			//jump
			if(enemy.body.touching.down){
